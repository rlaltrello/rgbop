...
class SetupScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        backgroundColor: const Color(0xFF121212), // Dark, sleek appliance vibe
        appBar: AppBar(
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // --- Status Icon ---
                  Icon(
                    provider.isConnected ? Icons.check_circle_outline : Icons.bluetooth_searching,
                    size: 80,
                    color: provider.isConnected ? Colors.green : Colors.blueAccent,
                  ),
                  ...
                  if (provider.isConnected) ...[
                    ...
                    ElevatedButton(
                      ...
                      child: provider.isSending 
                          ...
                          : const Text("Send to Panel", style: TextStyle(fontSize: 18)),
                    ),
                  ]
                ],
              ),
